...
const DesignWork = () => {
  ...
  return (
    <section className="section-padding-x font-geist">
      <motion.div
      ...
      >
        ...
        {/* Right Side Calendar */}
        <div className="w-full max-w-md bg-white rounded-[30px] md:rounded-[40px] p-6 md:p-10 shadow-[0_30px_60px_rgba(0,0,0,0.05)] border border-gray-100">
              ...
              >
                {item.day && (
                  ...
                  >
                    ...
                    <span
                      className={`relative z-20 text-sm font-bold transition-colors ${selectedDate === item.day ? "text-white" : "text-[#1a1a1a] group-hover:text-[#e85a2a]"}`}
                    >
                      {item.day}
                    </span>
                  </button>

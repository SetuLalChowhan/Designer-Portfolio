...
const ValuableService = () => {
  ...
  return (
    <section className="bg-[#2A2A2A] py-32 section-padding-x font-geist overflow-hidden">
      {/* Header Section */}
      <motion.div 
        initial="hidden"
        whileInView="visible"
      ...
      >
        <motion.div variants={itemVars} className="flex items-center justify-center gap-3 mb-6">
          ...
          <span className="text-[#e85a2a] text-sm font-bold uppercase tracking-[0.3em]">Services</span>
          <span className="w-1.5 h-1.5 rounded-full bg-[#e85a2a] animate-pulse"></span>
        </motion.div>
        
        <motion.h2 variants={itemVars} className="text-6xl md:text-7xl text-white font-medium mb-8 tracking-tight">
          Valuable <span className="font-playfair-display italic text-[#e85a2a]">Services</span>
        </motion.h2>
        
        <motion.p variants={itemVars} className="text-gray-500 text-xl max-w-2xl mx-auto font-light leading-relaxed">
      ...
      >
        {services.map((service, index) => (
          <motion.div
            ...
            className="group relative bg-[#2E2E2E] p-12 rounded-[40px] border border-white/5 cursor-pointer overflow-hidden"
          >
            ...
            <motion.div 
              ...
              className="w-14 h-14 bg-[#262626] border border-white/10 rounded-2xl flex items-center justify-center mb-10 shadow-xl group-hover:border-[#e85a2a]/40 group-hover:shadow-[#e85a2a]/10 transition-all duration-300"
            >
              {service.icon}
            </motion.div>

            <h3 className="text-3xl text-white font-semibold mb-5 tracking-tight group-hover:text-[#e85a2a] transition-colors duration-300">
              {service.title}
            </h3>
            
            <p className="text-gray-400 leading-relaxed text-lg font-light group-hover:text-gray-300 transition-colors duration-300">
              {service.description}
            </p>
